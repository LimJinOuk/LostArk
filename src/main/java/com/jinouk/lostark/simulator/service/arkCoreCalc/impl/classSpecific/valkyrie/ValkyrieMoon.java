...
public class ValkyrieMoon  extends AbstractArkGrid {
    ...
    public ArkGridResponseDto getArkGrid(ArkGridRequestDto requestDto) {
        ...
        requestDto.getArkGridItems().forEach(item -> {
            ...
            } else if ("빛의 서사".equals(name)) {
                calcEpicOfLight(effectsMap, point, grade);
            } else if ("구원의 서약".equals(name)) {
                calcOathOfSalvation(effectsMap, point, grade);
            } else if ("여명이 세상을 깨우는 순간".equals(name)) {
                calcMomentOfDawnAwakening(effectsMap, point, grade);
            }
    ...
    //
    private void calcEpicOfLight(Map<String, Double> effectsMap, int point, String grade) {
        if("유물".equals(grade)) {
            switch (point){
    ...
    //
    private void calcOathOfSalvation(Map<String, Double> effectsMap, int point, String grade) {
        if("유물".equals(grade)) {
            switch (point){
                case 10: mergeEffect(effectsMap, "아피강", 1.50); break;
    ...
    //
    private void calcMomentOfDawnAwakening(Map<String, Double> effectsMap, int point, String grade) {
        if("유물".equals(grade)) {
            switch (point){
                case 10: mergeEffect(effectsMap, "아피강", 1.50); break;
                case 14: mergeEffect(effectsMap, "아피강", 1.50); break;
