...
public class demonic {
    ...
    public demonicdto demonic(String title , ArkPassiveDTO dto){
        ...
        int 잠식_제어 = enlightment.getOrDefault("잠식 제어" , 0);
        int 무기_단련 = enlightment.getOrDefault("무기 단련" , 0);
        int 스톰_그라인딩 = enlightment.getOrDefault("스톰 그라인딩" , 0);
        int 잠식_흡수 = enlightment.getOrDefault("잠식 흡수" , 0);
        int 잠식_강화 = enlightment.getOrDefault("잠식 강화" , 0);
        ...
        int 혼돈_단련 = enlightment.getOrDefault("혼돈 단련" , 0);
        int 침식 = enlightment.getOrDefault("침식" , 0);
