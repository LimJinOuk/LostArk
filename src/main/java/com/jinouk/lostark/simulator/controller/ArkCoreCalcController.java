...
public class ArkCoreCalcController {
    ...
    public ResponseEntity<Map<String , ?>> suncorecalc(@RequestBody arkGridResponseDto dto){
    ...
    public ResponseEntity<Map<String , ?>> moomcorecalc(@RequestBody arkGridResponseDto dto){
        Map<String , Double> res = new HashMap<>();
    ...
    public ResponseEntity<Map<String , ?>> starcorecalc(@RequestBody arkGridResponseDto dto){
        Map<String , Double> res = new HashMap<>();
