...
function CharacterResultContent({ data, isDark }) {
    return (
        <div className="w-full space-y-8 animate-in fade-in slide-in-from-bottom-10 duration-1000">
                ...
                <div className="flex flex-col md:flex-row gap-10 items-center">
                    <div className="relative group">
                        ...
                        <div className={`relative w-44 h-44 rounded-full overflow-hidden border-4 ${isDark ? 'border-[#1a1a1b]' : 'border-white'} shadow-2xl bg-black/20 flex items-center justify-center`}>
                            <span className="text-white/20 italic font-black text-xl">RIO</span>
                        </div>
            ...
            {/* 2. 장비 & 악세사리 (여기서부터 새로 추가됨) */}
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                {/* 왼쪽: 방어구/무기 */}
                <div className="xl:col-span-2 space-y-6">
                    <h3 className="flex items-center gap-3 text-[18px] font-black uppercase tracking-widest px-2">
                        <Swords size={20} className="text-[#6d28d9]" /> Equipment
                    </h3>
                ...
                <div className="space-y-6">
                    <h3 className="flex items-center gap-3 text-[18px] font-black uppercase tracking-widest px-2">
                        <Gem size={20} className="text-[#6d28d9]" /> Accessories
                    </h3>
                    <div className="flex flex-col gap-4">
                        ...
                        <div className={`mt-4 p-6 rounded-[30px] border-2 border-dashed ${isDark ? 'border-[#6d28d9]/30 bg-[#6d28d9]/5' : 'border-[#6d28d9]/20 bg-purple-50'}`}>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="flex flex-col"><span className="text-[9px] font-black opacity-50 uppercase">Elixir</span><span className="text-[16px] font-black text-[#6d28d9]">40 (달인)</span></div>
                                <div className="flex flex-col"><span className="text-[9px] font-black opacity-50 uppercase">Trans.</span><span className="text-[16px] font-black text-[#6d28d9]">120단계</span></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className={`p-8 rounded-[35px] border ${isDark ? 'bg-[#121216] border-white/5 shadow-lg' : 'bg-white border-[#e2e8f0] shadow-lg'}`}>
